...
export default function Home(props) {
  ...
  return (
    <section id="articles-container" className="w-full bg-gray-100 flex flex-shrink-1 flex-col items-center justify-center mb-10 dark:bg-gray-900">
      ...
      {areMorePages ? (
        <button
          className="btn bg-white self-stretch max-w-85 m-4 bg-white text-gray-700 dark:bg-gray-800 dark:text-gray-300 dark:bg-gray-800 dark:border-gray-800 dark:hover:bg-gray-500"
